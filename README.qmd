...
[The "Unit conversions" vignette](https://profmusgrave.github.io/qatarcars/vignettes/unit-conversions.html) includes guidance and examples for making these different conversions, since not all of the variables involve straightforward multiplication.
