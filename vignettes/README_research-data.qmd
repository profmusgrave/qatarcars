...
(This follows [the "Writing READMEs for Research Data" template](https://data.research.cornell.edu/data-management/sharing/readme/) developed by Cornell Data Services.)
:::
...
* Licenses/restrictions placed on the data: Creative Commons Attribution BY 4.0 (https://creativecommons.org/licenses/by/4.0/)
...
* Variable List: 
  ...
  | `model` | Model (105 unique models, such as Tiggo 8 Pro Max and Rav4 Hybrid) |
  | `length` | Length (m) |
  | `width` | Width (m) |
  | `height` | Height (m) |
